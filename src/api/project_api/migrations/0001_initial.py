    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.FileField(blank=True,
                                            null=True, upload_to='images/%Y/%m/%d')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('textual_description', models.CharField(
                    blank=True, max_length=100, null=True)),
                ('video', models.FileField(blank=True,
                                           null=True, upload_to='videos/%Y/%m/%d')),
                ('audio', models.FileField(blank=True,
                                           null=True, upload_to='audio/%Y/%m/%d')),
                ('image', models.FileField(blank=True,
                                           null=True, upload_to='images/%Y/%m/%d')),
                ('confidence', models.IntegerField(default=0)),
                ('category', models.ForeignKey(blank=True, null=True,
                                               on_delete=django.db.models.deletion.SET_NULL, to='project_api.category')),
            ],
        ),
        migrations.CreateModel(
            name='Proposition',
            fields=[
                ...
                ('decision', models.CharField(choices=[
                 ('DFT', 'RAS'), ('CNF', 'Confirm'), ('INF', 'Infirm')], default='DFT', max_length=3)),
                ('created_at', models.DateTimeField(
                    blank=True, null=True, verbose_name='date created')),
                ('updated_at', models.DateTimeField(
                    blank=True, null=True, verbose_name='date uplated')),
                ('deleted_at', models.DateTimeField(
                    blank=True, null=True, verbose_name='date deleted')),
                ('incident', models.ForeignKey(blank=True, null=True,
                                               on_delete=django.db.models.deletion.SET_NULL, to='project_api.incident')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receive_at', models.DateTimeField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name='user_confirms', through='project_api.Proposition', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='incident',
            name='user',
